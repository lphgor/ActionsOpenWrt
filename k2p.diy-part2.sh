...
sed -i "/modulecache/ised -i '/DISTRIB_DESCRIPTION/ { s/SNAPSHOT/SNAPSHOT($(date +%Y.%m.%d-%H%M%S))/g; }' /etc/openwrt_release" ./package/lean/default-settings/files/zzz-default-settings
echo 0xDEADBEEF > ./feeds/helloworld/luci-app-ssr-plus/root/etc/config/google_fu_mode
sed -i '/DEPENDS:=+kcptun-config/d;s/20210922/20221015/g;s/2021-09-22/2022-10-15/g;s/f6a08f0fe75fa85d15f9c0c28182c69a5ad909229b4c230a8cbe38f91ba2d038/5163d439473252cdbfb870d8ebb322951dc047f3bad7ba93096ce1a953258e3a/g;' ./feeds/packages/net/kcptun/Makefile
sed -i 's/spi-max-frequency = <80000000>/spi-max-frequency = <50000000>/g' ./target/linux/ramips/dts/mt7621_phicomm_k2p.dts
